...
| **Day 3** | Context Engineering & Memory | ✅ Complete | [Sessions](./codelabs/day-3a-agent-sessions) -  [Memory](./codelabs/day-3b-agent-memory) -  [Questions](./expert-questions/day-3-expert-questions.md) |
